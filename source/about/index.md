...
- Fabian Schlotterbeck, **Hening Wang** (2023). *An incremental RSA model for adjective ordering preferences in referential visual context*. *Society for Computation in Linguistics*, 6(1), 121–132. [paper](https://openpublishing.library.umass.edu/scil/article/id/939/download/pdf/)
